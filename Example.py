...
filepath = 'C:/Users/HP/Documents/Tomato_Leaf_Disease_Prediction/model.h5'
model = load_model(filepath)
print(model)

print("Model Loaded Successfully")

tomato_plant = cv2.imread('C:/Users/HP/Documents/Tomato_Leaf_Disease_Prediction/Dataset/test/Tomato___Bacterial_spot (1).JPG')
